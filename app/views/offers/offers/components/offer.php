<section class="w-full h-auto flex flex-col justify-start items-start my-10 px-8 relative hover:before:bg-[var(--active-color-brown)] before:duration-75 before:ease-linear
    ...
    <span class="relative w-max h-auto mb-2">
        <a href="/offers/preview" data-content="<?php echo $data['id']; ?>" class="text-base font-medium text-[var(--main-font-color-90)] pr-2"><?php echo $data['title']; ?></a>
    ...
    <div class="flex justify-start items-start mb-3">
        ...
        <a href="/offers/preview" class="w-max h-auto flex justify-center items-center text-[var(--main-font-color-80)] hover:text-[var(--main-font-color-90)] duration-75
                ease-linear">
    ...
    <a href="/offers/preview" class="text-sm font-normal text-[var(--main-font-color-80)] line-clamp-3">
