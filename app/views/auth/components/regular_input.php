...
h-auto flex flex-col justify-start items-start px-2 my-2">
    ...
    <input id="<?php echo $input_id; ?>" type="<?php echo $input_type; ?>" value="<?php if (isset($value) && !empty($value)) {
                                                                                        echo $value;
                                                                                    } ?>" class="w-full h-[40px] border-none text-sm bg-[var(--bg-white-low)] ring-1 
