...
<body class="bg-[var(--main-bg-yellow)]">
    ...
    <main class="container mx-auto mt-10 mb-32 relative">
        <header class="w-full flex justify-center items-center">
            <h1 class="text-[var(--main-font-color-90)] font-medium text-xl md:text-2xl">Create new account</h1>
        </header>
        <section class="w-full flex justify-center items-center my-10 md:my-20">
            ...
            <div id="signup-form" class="hidden w-full max-w-[900px] h-auto flex-wrap justify-start items-start box-border px-2">
                ...
                ?>
                <button id="signup" class="w-full md:w-max py-2 px-2 bg-[var(--active-color-brown-low)] font-normal md:font-medium text-[var(--bg-white-low)] 
        ...
        <section class="w-full h-auto flex justify-center items-center">
            <p class="text-[var(--main-font-color-90)] font-normal text-base">Already have an account?
                <a href="/signin" class="underline text-base hover:text-[var(--active-color-brown)] ease-linear duration-75">log in</a>
            </p>
        </section>
    </main>
    <?php
