    ...
    <main class="container h-auto mx-auto mt-5 lg:mt-10 mb-32 box-border px-4 flex flex-col lg:flex-row justify-between items-start">
        ...
        lg:border-b-0 lg:border-l border-[var(--main-font-color-20)]">
            ...
            z-20 lg:z-auto left-1/2 -translate-x-1/2 lg:-translate-x-0 lg:left-auto bg-[var(--bg-white-low)] lg:bg-transparent">
                <button id="apply-job" class="w-36 h-auto flex justify-center items-center text-sm font-medium text-[var(--bg-white-low)] bg-[var(--active-color-brown-low)]
                ...
                <button data-job="<?php echo $id; ?>" id="save-job" class="w-36 h-auto flex justify-center items-center text-sm font-medium text-[var(--bg-white-low)] bg-[var(--main-font-color-80)]
