        ...
        <section class="w-full lg:w-[70%] h-auto flex flex-col justify-start items-start box-border">
            <div class="w-full h-auto border-b border-[var(--main-font-color-20)] pt-4 pb-5 lg:py-8 px-4 flex flex-col justify-start items-start">
                <p class="text-base font-normal text-[var(--main-font-color-80)] mb-3">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nulla atque incidunt, eligendi minima dolor commodi dicta laboriosam accusantium
                    voluptatibus assumenda!
                </p>
                <span class="text-sm font-normal text-[var(--main-font-color-30)]">Posted on today</span>
            </div>
            <div class="w-full h-auto border-b border-[var(--main-font-color-20)] pb-8 pt-4 px-4 flex flex-col justify-start items-start">
                ...
                <p class="text-sm font-normal text-[var(--main-font-color-80)] mt-10 leading-6">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente ipsam hic incidunt dolorem omnis voluptatibus eos similique! Laudantium
                    sed sunt, molestias corrupti esse hic optio quod expedita adipisci! Magnam, quas vitae molestiae earum facilis debitis repellat cum vel
                    nesciunt quasi perspiciatis in. Quam illum maiores sapiente doloremque exercitationem aliquam eaque earum sequi odio tempore molestias
                    nesciunt sed possimus nihil, dolorum ex ducimus odit impedit, enim praesentium explicabo repudiandae voluptatem tenetur doloribus?
                    Distinctio tempore quam harum voluptatibus voluptatum corrupti earum maiores consectetur vero, ad cumque provident aliquid, dolor
                    perspiciatis architecto maxime quisquam ducimus porro animi atque odio quod. Ipsum adipisci molestias modi, fugiat, perspiciatis inventore
                    laboriosam distinctio provident eligendi saepe deserunt aperiam officiis doloremque, quas animi rerum aliquam beatae a maxime corrupti
                    voluptatibus debitis obcaecati? Laborum quos explicabo ex voluptatem deleniti nostrum laboriosam provident ullam dolorum accusantium
                    reprehenderit accusamus ipsa dignissimos, placeat magnam vero quam, repellendus reiciendis cum magni, rem nulla.
                </p>
            ...
            <div class="w-full h-auto lg:border-b border-[var(--main-font-color-20)] pb-8 pt-4 px-4 flex flex-col justify-start items-start">
                ...
                <div class="w-auto h-auto">
                    <p class="text-sm font-medium text-[var(--main-font-color-80)] my-1">Applications:
                        <span class="text-sm font-normal">10</span>
                    </p>
                    ...
                    <p class="text-sm font-medium text-[var(--main-font-color-80)] my-1">Last Viewed:
                        <span class="text-sm font-normal">10 minutes ago</span>
                    </p>
                </div>
            </div>
        </section>
