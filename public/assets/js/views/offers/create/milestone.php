<!-- milestone -->
<div data-milestone="milestone-id" class="w-full h-auto flex justify-start items-center my-5">
    <button data-milestone-remove="milestone-id" class="w-max h-auto flex justify-center items-center text-[var(--active-color-brown-low)] hover:text-[var(--active-color-brown)]
                ...
                <div class="flex justify-center items-start">
                    ...
                    <div class="w-24 h-[35px] mr-3">
                        ...
                        <span class="w-full h-full relative flex flex-col justify-start items-center">
                            <button data-select-value="1" data-select-trigger="milestone-id" class="w-full h-full ring-1 ring-[var(--main-font-color-20)] 
                                ...
                                <span data-select-selected="milestone-id" class="w-full h-auto text-sm font-normal text-[var(--main-font-color-80)] truncate pointer-events-none">
                                    Fixed
                                </span>
                            ...
                            <div data-select="milestone-id" data-show="false" class="w-full h-auto absolute top-[110%] left-0 bg-[var(--bg-white-low)] py-2 z-10 border 
                                                border-[var(--main-font-color-20)] overflow-hidden  max-h-0 invisible shadow-lg">
                                <button data-select-option="milestone-id" data-select-value="1" class="w-full min-w-max text-sm text-[var(--main-font-color-80)] 
                                ...
                                <button data-select-option="milestone-id" data-select-value="2" class="w-full min-w-max text-sm text-[var(--main-font-color-80)] 
                                                    font-normal hover:bg-[var(--main-font-color-10)] hover:text-[var(--main-font-color-90)] duration-75 ease-linear px-4 py-2 flex 
                                                    justify-start items-center">
                                    Hourly
                                </button>
                    ...
                    <label for="milestone-id" class="w-max h-auto relative">
                        ...
                        <input id="milestone-id" type="text" placeholder="Price" class="w-24 h-[35px] text-sm text-[var(--main-font-color-80)] border-none outline-none ring-1
